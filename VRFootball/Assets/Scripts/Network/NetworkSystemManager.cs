...
public class NetworkSystemManager : MonoBehaviourPunCallbacks
{
    ...
    public void ConnectNow()
    {
        ...
        settings.AppVersion = Version.ToString();
        settings.AppIdRealtime = "33d4be8d-f0f8-4c64-8cbc-8e6f389a1faa";
    ...
    public override void OnJoinedRoom()
    {
        ...
        PhotonNetwork.Instantiate(NetworkPrefabs.networkTrainerAvatar, PlayerAvatarHolder.instance.body.position, Quaternion.Euler(0f, 180f, 0f), 0);
        PhotonNetwork.Instantiate(NetworkPrefabs.ball, new Vector3(), Quaternion.identity, 0);
    }
}
